...
hl.bind(
	main_mod .. " + SHIFT + CTRL + C",
	hl.dsp.exec_cmd(terminal .. " --hold -d ~/dotfiles/ fish -c 'nvim ~/.config/hypr/hyprland.lua'")
)
...
hl.bind(
	...
	hl.dsp.exec_cmd("hyprctl dispatch resizeactive exact 1200 800 && hyprctl dispatch centerwindow")
)
hl.bind(
	main_mod .. " + CTRL + C",
	hl.dsp.exec_cmd(
...
hl.bind(
	main_mod .. " + CTRL + B",
	hl.dsp.exec_cmd("bluetoothctl connect " .. headphones_id .. ' && notify-send "Bluetooth" "Device connected"')
)
...
hl.bind(
	main_mod .. " + O",
	helpers.focus_or_launch("nvim-current", "kitty --class nvim-current fish -c 'nvim current.md'")
)
